 ...
 *
 * @param <T> Tipo de Objetos que se almacenan en los Vertices y Aristas del
 * Grafo
 * @author Uriel Garcia
 * @version 1.0
 */
public class Digrafo<T> {
    ...
    ////////////////////////////////////////////////////////////
    /**
     * Metodo constructor del Digrafo que inicializa el Listado de Vertices y
     * Aristas. <br>
    ...
    private ArrayList<Vertice> global = new ArrayList();
    ...
    public void getCaminos(Vertice origen,Vertice destino) {
        ...
        if (!origen.equals(destino)) {
            if (origen.getVecinos().getTamanio() > 1) {
                listasBase.add((ArrayList<Vertice>) global.clone());
                for (int i = 0; i < origen.getVecinos().getTamanio(); i++) {
    ...
    public ArrayList<ArrayList<Vertice>> getCaminos() {
        return caminos;
    }
     ...
     * <br>
     * <b> post: </b> Se inserto una nueva Arista dentro del Listado del Grafo.
     * <br>
     *
    ...
    /**
     * Metodo que permite insertar una nueva Arista con peso en el Listado del
     * Grafo. <br>
     * <b> post: </b> Se inserto una nueva Arista dentro del Listado del Grafo.
     * <br>
     *
    ...
    /**
     * Metodo que permite eliminar un Vertice del listado del Grafo; Se eliminan
     * tambien sus relaciones. <br>
     * <b> post: </b> Se elimino el Vertice del grafo, incluso sus relaciones en
     * el mismo. <br>
     *
     * @param info Representa la informacion del Vertice que se desea eliminar.
     * <br>
     */
     ...
     *
     * @param orig Representa la informacion del Vertice origen de la Arista.
     * <br>
     * @param dest Representa la informacion del Vertice destino de la Arista.
     * <br>
     * @return
     */
    ...
    /**
     * Metodo que permite buscar un Vertice dentro del listado de Vertices en el
     * Grafo. <br>
     ...
     * @return Un Objeto de tipo Vertice que representa el Vertice consultado.
     * <br>
     */
    ...
    /**
     * Metodo que permite buscar una Arista dentro del listado de Aristas en el
     * Grafo. <br>
     * <b> post: </b> Se retorno la Arista consultada dentro del Listado. <br>
     *
     * @param info1 Representa la informacion del Vertice en un extremo de la
     * Arista. <br>
     * @param info2 Representa la informacion del Vertice en un extremo de la
     * Arista. <br>
     * @return Un Objeto de tipo Arista que representa la Arista consultada.
     * <br>
     */
    ...
    /**
     * Metodo que permite evaluar la existencia de un Vertice dentro del Grafo.
     * <br>
     * <b> post: </b> Se evaluo la existencia de un Vertice dentro del Grafo.
     * <br>
     *
    ...
    ////////////////////////////////////////////////////////////
    /**
     * Metodo que permite conocer la matriz de adyacencia del Grafo, que es una
     * de sus representaciones; <br>
     * La primera fila y columna de la matriz representan la informacion de los
     * Vertices, por lo que no posee valores. <br>
     * <b> post: </b> Se retorno la representacion de la matriz de adyacencia
     * del Grafo. <br>
     *
     * @return Una matriz de Object con la representacion del Grafo en su matriz
     * de Adyacencia.
     */
    ...
    /**
     * Metodo que permite conocer la Lista de Adyacencia de Grafo; Es una mas de
     * sus representacione; <br>
     * Se ha implementado de manera que se represente atravez de un Arreglo de
     * ListasCD de Vertices. <br>
     * <b> post: </b> Se retorno la lista de Adyacencias del Grafo. <br>
     *
     * @return Un Objecto de tipo Array de Listas (ListaCD[]) que representa el
     * grado como Lista de Adyacencias.
     */
    ...
    /**
     * Metodo que permite conocer la Matriz de Incidencia del Grafo; Otra de sus
     * representaciones; <br>
     * La primera fila y columna representan la informacion de los Vertices y
     * Aristas, debe tenerse en cuenta. <br>
     * <b> post: </b> Se retorno el Grafo representado por su matriz de
     * Incidencia. <br>
     *
     * @return Una matriz de Object con la representacion del Grafo en su matriz
     * de Incidencia.
    ...
    ////////////////////////////////////////////////////////////
    /**
     * Metodo que permite evaluar si el Grafo es un Multigrado; es decir, si
     * existen mas de <br>
    ...
    /**
     * Metodo que permite evaluar si el Grafo es un PseudoGrafo; es decir, si
     * existe una<br>
    ...
    /**
     * Metodo que permite conocer si un Grafo evaluado es SImple; Un Grafo es
     * simple cuando <br>
    ...
    /**
     * Metodo que permite conocer si un Grafo es Ponderado; Un Grafo es
     * ponderado cuando <br>
     * sus Aristas poseen un valor que representa costos, tiempos, distancias.
     * <br>
    ...
    /**
     * Metodo que permite conocer si un Grafo es Nulo; Un Grafo es Nulo cuando
     * <br>
     * posee una cantidad de Vertices que no se encuentran relacionados NINGUNO,
     * Para el caso <br>
     * se dice que el Arbol es N(n), donde n es el numero de Vertices.
     * <b>post:</b> Se evaluo si el Grafo creado es un Grafo NUlo. <br>
     *
     * @return Un objeto de int con el numero de vertices NULOS, o -1 si no es
     * NULO
     */
    ...
    /**
     * Metodo que permite conocer si un Grafo es Conexo; Un Grafo es conexo
     * cuando <br>
    ...
    /**
     * Metodo de tipo privado que permite visitar los Vecinos de un Vertice y
     * marcalos como visitados. <br>
     *
     * @param v Representa el Vertice del cual se quieren visitar sus vecinos.
     * <br>
     */
    ...
    /**
     * Metodo de tipo privado que permite evaluar si todos los vertices del
     * Grafo han sido visitados. <br>
     *
     * @return Un objeto de tipo boolean qeu es true= si ha visitado todos los
     * Vertices en el recorrido.
     */
    ...
    /**
     * Metodo de tipo privado que permite limpiar la visita de los Vertices
     * dentro de un recorrido. <br>
     */
    ...
    /**
     * Metodo de tipo privado que permite limpiar la visita de las Aristas
     * dentro de un recorrido. <br>
     */
    ...
    /**
     * Metodo que permite conocer si un Grafo es Fuertemente Conexo; Un Grafo es
     * Fuertemente conexo cuando <br>
     * se puede acceder a cada uno de sus vertices desde cada uno de ellos. <br>
     * <b>post:</b> Se evaluo si el Grafo creado es un Grafo Fuertemente Conexo.
     * <br>
     *
     * @return Un objeto de tipo boolean con el resultado de la operacion.
     */
    ...
    /**
     * Metodo que permite conocer si un Grafo es Regular; Un Grafo es Regular
     * cuando <br>
    ...
    /**
     * Metodo que permite conocer si un Grafo es Completo; Un Grafo es Completo
     * cuando <br>
     * se posee una (y sola una) Arista entre cada uno de los Vertices del
     * Grafo, se representa por K(n). <br>
     * <b>post:</b> Se evaluo si el Grafo creado es un Grafo Completo. <br>
     *
     * @return Un objeto de tipo int con el Numero de vertices del Grafo
     * completo o -1 si no lo es.
     */
    ...
    /**
     * Metodo que permite conocer si un Grafo Dirigido es Simetrico; Un Digrafo
     * es Simetrico cuando <br>
     * existe una Arista entre cada unos de sus vertices y en ambos sentidos;
     * Ej: A->B, B->A. <br>
    ...
    /**
     * Metodo que permite conocer si un Grafo es un Ciclo; Un Grafo es un ciclo
     * cuando <br>
     * sus Vertices y Aristas forman un figura que se asemeja a un polígono de n
     * lados; <br>
     * Se representa con C(n) donde n es el numero de Vertices. <br>
     * <b>post:</b> Se evaluo si el Grafo creado es un Grafo Ciclico. <br>
     *
     * @return Un Objeto de tipo int que representa el numero de Vertices o -1
     * si no es ciclo.
     */
    ...
    ////////////////////////////////////////////////////////////
    /**
     * Metodo que permite conocer si un Grafo es GrafoHamiltoniano, es decir,
     * represente un circuito Hamiltoniano; <br>
     * Un Grafo es Hamiltoniano si existe una sucesión de aristas adyacentes,
     * que visita todos los vértices del grafo una sola vez. <br>
     ...
     *
     * @return Un objeto de tipo ListaCD que representa el recorrido del Grafo
     * Hamiltoniano.
     */
    ...
    /**
     * Metodo de tipo privado que permite generar el recorrido del Arbol
     * Hamiltoniano. <br>
     *
     * @param v2 Representa el Vertice sobre el cual se encuentra iterando
     * durante el recorrido. <br>
     * @param l Representa la lista donde se almacena el recorrido del Grafo.
     * <br>
     * @param orig Representa el vertics desde el cual comienza el recorrido.
     * <br>
     * @return Un objeto de tipo boolean dependiendo si existe el Grafo
     * Hamiltoniano.
     */
    ...
    /**
     * Metodo que permite conocer si existe un camino Hamiltoniano en el Grafo;
     * <br>
     * Un camino Hamiltoniano es una sucesión de aristas adyacentes, que visita
     * todos los vértices del grafo una sola vez. <br>
     * <b>post:</b> Se evaluo si el Grafo creado posee un camino Hamiltoniano.
     * <br>
     *
     * @return Un objeto de tipo boolean con el resultado de la operacion.
     */
     ...
     *
     * @return Un objeto de tipo ListaCD que representa el camino del Grafo
     * Hamiltoniano.
     */
     ...
     * <br>
     *
     * @param v2 Representa el Vertice sobre el cual se esta iterando en el
     * momento del recorrido. <br>
     * @param l Representa el listado donde se almacena el camino Hamiltoniano
     * del Grafo. <br>
     * @return Un objeto de tipo boolean con el resultado de la operacion.
     */
    ...
    /**
     * Metodo que permite conocer si un Grafo es GrafoEuleriano, es decir,
     * representa un circuito Euleriano; <br>
     * Un Grafo es Euleriano si posee un camino que recorre todas las aristas de
     * un grafo tan solo una única vez, <br>
    ...
    /**
     * Metodo que permite conocer si existe un camino Euleriano en el Grafo;
     * <br>
     * Un camino Euleriano posee un camino que recorre todas las aristas de un
     * grafo tan solo una única vez. <br>
     ...
     * @param v2 Representa el Vertice sobre el cual se esta iterando en el
     * momento del recorrido. <br>
     * @param l Representa el listado donde se almacena el camino Euleriano del
     * Grafo. <br>
     * @return Un objeto de tipo boolean con el resultado de la operacion.
     */
    ...
    /**
     * Metodo que permite evaluar la existencia de un camino entre dos vertices
     * del Grafo Conexo. <br>
     * <b> post: </b> Se evaluo la existencia de una ruta entre dos vertices.
     * <br>
     *
     * @param orig Representa el vertice en el orgen de la ruta a consultar.
     * <br>
     * @param dest Representa el vertice en el destino de la ruta a consultar.
     * <br>
     * @return Un objeto de tipo boolean que es true si existe ruta entre los
     * vertices.
     */
    ...
    /**
     * Metodo de tipo privado que permite evaluar la existencia de un camino
     * entre dos vertices del Grafo Conexo. <br>
     * <b> post: </b> Se evaluo la existencia de una ruta entre dos vertices.
     * <br>
     *
     * @param orig Representa el vertice en el orgen de la ruta a consultar.
    ...
    /**
     * Metodo que permite devolver el camino entre dos vertices del Grafo
     * Conexo. <br>
     * <b> post: </b> Se retorno la ruta entre dos Vertices de un Grafo conexo.
     * <br>
     *
     * @param orig Representa el vertice en el orgen de la ruta a consultar.
     * <br>
     * @param dest Representa el vertice en el destino de la ruta a consultar.
     * <br>
     * @return La ruta entre los dos vertices indicados, representados en una
     * Lista.
     */
    ...
    /**
     * Metodo de tipo privado que permite devolver el camino entre dos vertices
     * del Grafo Conexo. <br>
     * <b> post: </b> Se retorno la ruta entre dos Vertices de un Grafo conexo.
     * <br>
     *
    ...
    /**
     * Metodo que permite conocer la longitud en numero de Nodos de camino entre
     * dos vertices del Grafo Conexo. <br>
     * <b> post: </b> Se retorno la longitud de camino de la ruta entre dos
     * Vertices de un Grafo conexo. <br>
     *
     * @param orig Representa el vertice en el orgen de la ruta a consultar.
     * <br>
     * @param dest Representa el vertice en el destino de la ruta a consultar.
     * <br>
     * @return Un objeto de tipo int con la longitud de camino entre los
     * Vertices.
     */
     ...
     * @param dest Representa el vertice en el destino de la ruta a consultar.
     * <br>
     * @param longi Representa las longitud de camino para cada uno de los
     * Vertices. <br>
     * @return Un objeto de tipo int con la longitud de camino entre los
     * Vertices.
     */
    ...
    /**
     * Metodo que permite conocer la longitud ponderada de camino entre dos
     * vertices del Grafo Conexo. <br>
     * <b> post: </b> Se retorno la longitud de camino de la ruta entre dos
     * Vertices de un Grafo conexo. <br>
     *
     * @param orig Representa el vertice en el orgen de la ruta a consultar.
    ...
    /**
     * Metodo que permite conocer la longitud en sumatoria del peso de aristas
     * de camino entre dos vertices del Grafo Conexo. <br>
     * <b> post: </b> Se retorno la longitud de camino de la ruta entre dos
     * Vertices de un Grafo conexo. <br>
     *
     * @param orig Representa el vertice en el orgen de la ruta a consultar.
    ...
    /**
     * Metodo que permite calcular el peso de la ruta minima entre dos Vertices
     * indicados. <br>
     * <b> post:</b> Se retorno la longitud de la ruta minima entre dos
     * Vertices. <br>
     *
     * @param ini Representa el Vertice inicial en el recorrido del Dijsktra.
     * <br>
     * @param fin Representa el Vertice final en el recorrido del Dijsktra. <br>
     * @return Un objeto de tipo int con el valor de la longitud de la ruta
     * Minima.
     */
     ...
     * Vertices. <br>
     *
     * @param vIni Representa el Vertice inicial en el recorrido del Dijsktra.
     * <br>
     * @param vFin Representa el Vertice final en el recorrido del Dijsktra.
     * <br>
     * @param costos Representa los costos minimos de cada vertice en el
     * recorrido. <br>
     */
    ...
    /**
     * Metodo de tipo privado que permite calcular el peso de la ruta minima
     * entre dos Vertices indicados. <br>
     ...
     * @param costos Representa los costos minimos de cada vertice en el
     * recorrido. <br>
     * @param l Representa el recorrido del camino minimo entre dos vertices.
     * <br>
     */
    ...
    /**
     * Metodo de tipo privado que permite evaluar la existencia de Aristas con
     * peso negativo. <br>
     *
     * @return Un objeto de tipo boolean con true si existen aristas con pesos
     * negativos. <br>
     */
    ...
    /**
     * Metodo que permite calcular la ruta mas corta entre dos Vertices
     * indicados. <br>
     ...
     * @return Un objeto de tipo int con el valor de la longitud de la ruta mas
     * corta.
     */
    ...
    /**
     * Metodo de tipo privado que permite retornar la longitud de la ruta mas
     * corta entre 2 vertices. <br>
     *
     * @param vIni Representa el Vertice inicial del recorrido. <br>
     * @param vFin Representa el Vertice final o destino final del recorrido.
     * <br>
     * @param cant Representa la cantidada de iteraciones realizadas sobre e
     * Grafo. <br>
    ...
    /**
     * BUSQUEDA EN PROFUNDIDAD Metodo que permite realizar el recorrido del
     * Grafo en Profunidad. <br>
     * <b>post:</b> Se realizo un recorrido del Grafo en profundidad. <br>
     *
     * @param infoVert Representa la informacion del Vertices inicial sobre el
     * cual comienza el recorrido. <br>
     * @return Un objeto de tipo ListaCD con el recorrido del Grafo en
     * profundidad.
     */
    ...
    /**
     * Metodo de tipo privado que permite realizar el recorrido del Grafo en
     * Profunidad. <br>
     * <b>post:</b> Se realizo un recorrido del Grafo en profundidad. <br>
     *
     * @param v Representa el Vertice inicial sobre el cual comienza el
     * recorrido. <br>
    ...
    /**
     * BUSQUEDA EN ANCHURA Metodo que permite realizar el recorrido del Grafo en
     * Anchura. <br>
     ...
     * @param c Representa una cola auxiliar como ayuda para el recorrido en
     * Anchura
     */
     ...
     *
     * @return Un objeto de tipo boolean con true si el Grafo se encuentra
     * vacio.
     */
     ...
     *
     * @param orig Representa el Vertice del cual se desea saber si es
     * adyacente. <br>
     * @param dest Representa el Vertice del cual se desea saber si es
     * adyacente. <br>
     * @return Un objeto de tipo boolean que evalua la adyacencia de los dos
     * Vertices.
     */
    ...
    /**
     * Metodo que permite evaluar si un Vertice se encuentra aislado dentro del
     * Grafo. <br>
     * <b>post:</b> Se evaluo si un Vertice es Aislado en el Grafo. <br>
     *
     * @param info Representa la informacion del Vertice que se desea evaluar.
     * <br>
    ...
    /**
     * Metodo que permite conocer los vertices adyacentes/vecinos a un vertice
     * indicado. <br>
     * <b>post:</b> Se retorno el conjunto de Vertices vecinos al info indicado.
     * <br>
     *
     * @param info Representa la informacion del Vertice que se desea evaluar.
     * <br>
     * @return Un objeto de tipo ListaCD con los vertices vecinos al Vertice
     * indicado.
     */
    ...
    /**
     * Metodo que permite limpiar el apuntador a los Vertices predecesores en el
    ...
    /**
     * Metodo que permite evaluar la existencia de un circuito dentro del Grafo;
     * Un circuito es una secuencia de Vertices en la cual el vertice inicial y
     * vertice final coinciden. <br>
    ...
    /**
     * Metodo que permite conocer los circuitos existentes dentro del Grafo.
     * <br>
     * <b>post:</b> Se retorno el listado de Circuitos existentes dentro del
     * Grafo. <br>
     *
     * @return Un objeto de tipo ListaCD con el conjunto de Circuitos existentes
     * dentro del Grafo
     */
    ...
    /**
     * Metodo que permite evaluar si una Arista es un PUENTE dentro del Grafo;
     * <br>
     * Un PUESTE es una Arista que eliminandose desconecta el Grafo. <br>
     * <b>post:</b> Se evaluo lo existencia de la Arista puente dentro del
     * Grafo. <br>
     *
     * @param info1 Representa la informacion del primer Vertice de la Arista.
     * <br>
     * @param info2 Representa la informacion del segundo Vertice de la Arista.
     * <br>
     * @return Un objeto de tipo boolean con true si la Arista en un puente del
     * Grafo.
     */
    ...
    /**
     * Metodo que permite evaluar si un Vertice es una Articulacion del Grafo.
     * <br>
     ...
     *
     * @param info Representa la informacion del Vertice que se quiere evaluar
     * como Articulacion. <br>
     * @return Un objeto de tipo boolean con true si el Vertice evaluado es una
     * Articulacion.
     */
    ...
    /**
     * Metodo que permite clonar la informacio de un Grafo en un nuevo grafo y
     * retornarlo. <br>
     * <b>post:</b> Se realizo la clonacion de la informacion del Grafo en un
     * nuevo Grafo. <br>
     *
     * @return Un nuevo Digrafo que representa el grafo con la informacion
     * clonada.
     */
    ...
    /**
     * Metodo que permite conocer si un Grafo es un subgrafo de un Grafo mas
     * grande. <br>
     * <b>post:</b> Se evaluo si un grafo hace parte minima de otro grafo. <br>
     *
     * @param g Representa el grafo el cual se desea saber si es un subgrafo de
     * otro grafo. <br>
     * @return Un objeto boolean con true si es subgrafo y false en caso
     * contrario.
     */
     ...
     * <b>post:</b> Se realizo la union de dos grafos en un Grafo unico con toda
     * la informacion. <br>
     *
     * @param g Representa el Grafo el cual se desea ser unido al Grafo actual.
     * <br>
     */
